...
/// 広告ユニットID
///
/// Androidはリリースビルドでのみ本番ID、デバッグ時はGoogle公式のテストIDを使う
/// （開発中の自己タップによる無効なトラフィック判定を避けるため）。
/// iOSは本番IDの設定待ちのため、現在は常にテストID。
class AdUnitIds {
  static String get banner {
    if (Platform.isAndroid) {
      return kDebugMode
          ? 'ca-app-pub-3940256099942544/6300978111'
          : 'ca-app-pub-5058227312086483/7793638149';
    }
  ...
  static String get interstitial {
    if (Platform.isAndroid) {
      return kDebugMode
          ...
          : 'ca-app-pub-5058227312086483/8490632980';
    }
