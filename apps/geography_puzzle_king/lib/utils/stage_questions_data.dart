...
const List<StageQuestion> stageOneQuestions = [
  ...
  StageQuestion(
    ...
    correctIndex: 2,
    explanation:
        'ホタテは北海道を代表する水産物で、生産量は全国の90%以上を占めています。噴火湾やサロマ湖・オホーツク海沿岸が主な産地で、毎年20万トン以上が生産されます。高級食材として国内外で人気があり、北海道の漁業産出額の大部分を占めています。イカも有名な産物で、スルメイカが北洋で多く捕獲されます。',
    difficulty: 'normal',
    keywords: ['ホタテ生産', '90%以上', 'オホーツク海', '高級食材'],
  ),
  ...
  StageQuestion(
    ...
    correctIndex: 2,
    explanation:
        '北海道は全国の天然ガス産出量の約70%を占め、エネルギー供給の重要な地域です。苫小牧市の勇払油ガス田などで採掘されており、北海道内の工業・発電・暖房用途で利用されています。石油・石炭の減少に伴い、天然ガスへの依存度がますます高まっています。',
    difficulty: 'hard',
    keywords: ['天然ガス70%', '勇払油ガス田', 'エネルギー供給'],
  ),
  ...
  StageQuestion(
    ...
    correctIndex: 1,
    explanation:
        '北海道の積雪深は地域によって大きく異なります。特にトマム周辺の内陸山間部は積雪が多く、年間最大積雪深が5～10mに達する地域もあります。札幌は平均約60～100cm程度ですが、周辺の山地ではより多くの雪が降ります。この豊富な雪資源はスキー場の運営を支えています。',
    difficulty: 'hard',
    keywords: ['積雪深', '内陸豪雪地帯', 'スキー場'],
  ),
...
const List<StageQuestion> stageTwoQuestions = [
  ...
  StageQuestion(
    ...
    correctIndex: 0,
    explanation:
        '仙台藩は表高62万石（実高はさらに多かったとされる）で、江戸時代を通じて東北地方最大の藩でしたが、面積で見ると東北地方全体（約66,400km²）の1割程度にとどまります。東北には仙台藩のほかにも盛岡藩・秋田藩・会津藩・米沢藩など多くの藩が分立しており、伊達政宗が開いた仙台は城下町として発展し、現在の宮城県の経済・文化の中心地となっています。',
    difficulty: 'hard',
    keywords: ['仙台藩62万石', '東北地方約10%', '伊達政宗', '城下町'],
  ),
...
const List<StageQuestion> stageFourQuestions = [
  ...
  StageQuestion(
    ...
    options: ['奈良大仏', '奈良公園の鹿', '古都奈良の文化財（世界遺産）', 'すべて'],
    correctIndex: 3,
    explanation:
        '奈良県は日本を代表する歴史・文化の地です。特に奈良大仏（東大寺）・奈良公園（奈良鹿）・世界遺産「古都奈良の文化財」（東大寺・興福寺・春日大社等）など、世界的に知られた文化遺産が多数あります。奈良県の観光客数は年間約1,500万人で、日本を代表する観光地です。710年から794年まで奈良時代として日本の政治・文化の中心地でした。',
    difficulty: 'easy',
...
const List<StageQuestion> stageFiveQuestions = [
  ...
  StageQuestion(
    ...
    difficulty: 'normal',
    keywords: ['佐賀県農業3%', '有明海海苔30%', '有明海の海苔養殖'],
  ),
  ...
  StageQuestion(
    ...
    correctIndex: 1,
    explanation:
        '長崎県は複雑なリアス式海岸を持つ漁業県で、水産業産出額が全国5位です。特にイカ・トラフグ・ヒオウギガイなどが主要産物で、五島列島や対馬地方が有名な漁場です。また東シナ海・九州西沖での遠洋漁業も盛んです。江戸時代の鎖国時代には唯一の対外貿易地であり、国際交易の拠点でもありました。',
    difficulty: 'normal',
